...
$bowtie2 -q -p $threadUse --un-gz $workspace/rmhostreads/$sraid.clean.gz -x $humanbowtie2Reference -U $workspace/fastp/$sraid/$sraid.clean.fastq.gz -S $workspace/maphuman/$sraid.human.sam
# Step4: alignment
...
# Step3: remove reads aligned to the host genome
$bowtie2 -q -p $threadUse -x $humanbowtie2Reference -1 $workspace/fastp/$sraid/${sraid}.clean.R1.fastq.gz -2 $workspace/fastp/$sraid/${sraid}.clean.R2.fastq.gz -S $workspace/maphuman/$sraid.human.sam --un-conc $workspace/rmhostreads/$sraid.clean.fq
# Step4: alignment
